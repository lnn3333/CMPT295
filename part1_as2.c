...
void print_jal(Instruction instruction) {
    //unsigned int offset = get_jump_offset(instruction); offset
...
void print_store(char *name, Instruction instruction) {
    /* YOUR CODE HERE */
    unsigned int offset_s = get_store_offset(instruction);
    printf(BRANCH_FORMAT, name, instruction.stype.rs1,offset_s,
         instruction.stype.rs2);
}

void print_branch(char *name, Instruction instruction) {
    /* YOUR CODE HERE */
    printf(BRANCH_FORMAT, name, instruction.sbtype.rs1,
         instruction.sbtype.rs2, get_branch_offset(instruction));
}
